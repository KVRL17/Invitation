  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-2xl text-center">
        <Reveal direction="up">
          <h2 className="font-script text-5xl leading-[1.15] text-burgundy sm:text-6xl md:text-7xl">
            We Can&apos;t Wait
            <br />
        ...
        <Reveal direction="up" delay={0.25} className="mt-8">
        ...
        <Reveal direction="up" delay={0.4} className="mt-6">
        ...
        {/* interlocked rings */}
        <Reveal direction="up" delay={0.5} className="mt-12 flex justify-center">
          <div className={reduce ? undefined : 'anim-float-slow'}>
            <InterlockedRings size={240} />
          </div>
        </Reveal>

        <Reveal direction="up" delay={0.65} className="mt-10">
