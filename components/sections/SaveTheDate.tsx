...
export function SaveTheDate() {
  ...
  return (
    <section id="save-the-date" className="relative overflow-hidden px-5 py-24 sm:py-32" aria-label="Save the date">
      {/* backdrop */}
      <div
      ...
      <div className="relative z-10 mx-auto max-w-xl text-center">
        <Reveal direction="up">
          ...
          <h2 className="mt-1 font-script text-6xl text-burgundy sm:text-7xl">The Date</h2>
        </Reveal>
        ...
        <Reveal direction="up" delay={0.2} className="mt-12">
          <div className="relative mx-auto max-w-sm rounded-[2rem] border border-gold/35 bg-white/70 p-2 shadow-card backdrop-blur">
            <div className="rounded-[1.6rem] border border-gold/20 bg-gradient-to-b from-ivory to-champagne/70 px-6 py-10">
              {/* month header */}
              ...
              <div className="mt-4 flex items-start justify-center gap-3" aria-label={`Day ${day}`}>
                {dayStr.split('').map((d, i) => (
                  <motion.span
                    key={i}
                    className="font-serif text-8xl font-semibold leading-none text-burgundy sm:text-9xl"
              ...
              {/* weekday ribbon */}
              <div className="mt-6 inline-flex items-center gap-3 rounded-full border border-gold/30 bg-ivory/80 px-6 py-2">
